      ...
      <Box mt="2%" mb="2%">
        <Flex gap={"5%"}>
          <Box>
            ...
            <Box mt="4" mb={4}>
              <Flex gap="4">
                <Avatar
                  ...
                  h={10}
                  w={10}
                  name={propertyData.host_name}
                  src={propertyData.host_picture_url}
                />
                ...
                <Box>
                  ...
                  >
                    Hosted by {propertyData.host_name}
                  </Text>
            ...
            >
              ...
              <Flex m={4} gap={"10%"}>
                ...
                <Box>
                  ...
                  <Text>
                    Guests can cancel their reservation for free before March
                    5th.
                  </Text>
                </Box>
              </Flex>
            ...
            <Modal
              isOpen={isOpenShow}
              onClose={() => setIsOpenShow((prev) => !prev)}
            >
              <ModalOverlay />
              <ModalContent>
              ...
              <Flex gap={5} m="1%" fontSize={["sm", "sm", "md", "lg"]}>
                <Box m={"1%"}>
                  <Image
                    ...
                    src="https://a0.muscache.com/im/pictures/06c339b1-0b56-4357-8900-cd841149b5b7.jpg?im_w=480"
                    alt={`Room-Image`}
                  />
                  <Box m="1.5%">
                ...
                <Box m={"1%"} mb={3}>
                  <Image
                    ...
                    transition="all 0.3s ease"
                    _hover={{ transform: "scale(1.05)" }}
                    src="https://a0.muscache.com/im/pictures/f75a6ceb-b36e-4c37-93b1-8e87f1843f19.jpg?im_w=480"
                    alt={`Room-Image`}
                  />
                  <Box m="1.5%">
                    <Text>bedroom 2</Text>
            ...
            <Box m={4}>
              ...
              <Modal
                isOpen={isOpenAmenity}
                onClose={() => setIsOpenAmenity((prev) => !prev)}
              >
                <ModalOverlay />
                <ModalContent>
            ...
            <Box
              ...
              fontSize={["sm", "sm", "md", "lg"]}
            >
              <Text fontWeight={"500"} fontSize={["sm", "md", "lg", "xl"]}>
              ...
              >
                <Box>
                  <Text ml={2} fontWeight={500} fontSize={"medium"}>
                    Check-in Date:
                  </Text>
                ...
                >
                  <Flex m={2}>
                    ...
                    <Box>
                      <Button
                        borderRadius={"50%"}
                        onClick={() =>
                          setAdult((prev) => Math.max(prev - 1, 1))
                        }
                        disabled={adult <= 1}
                        opacity={adult <= 1 ? 0.1 : 1}
                      >
                        -
                      </Button>
                      <Input
                      ...
                      <Button
                        borderRadius={"50%"}
                        onClick={() =>
                          setAdult((prev) => Math.min(prev + 1, 3))
                        }
                        disabled={adult >= 3}
                        opacity={adult >= 3 ? 0.1 : 1}
                      >
                        +
                      </Button>
                    </Box>
                  ...
                  <Flex m={2}>
                    ...
                    <Box>
                      ...
                      <Button
                        borderRadius={"50%"}
                        onClick={() =>
                          setChildren((prev) => Math.min(prev + 1, 2))
                        }
                        disabled={children >= 2}
                        opacity={children >= 2 ? 0.1 : 1}
                      >
                        +
                      </Button>
                    </Box>
                  ...
                  <Flex m={2}>
                    ...
                    <Box>
                      ...
                      <Button
                        borderRadius={"50%"}
                        onClick={() =>
                          setInfants((prev) => Math.min(prev + 1, 5))
                        }
                        disabled={infants >= 5}
                        opacity={infants >= 5 ? 0.1 : 1}
                      >
                        +
                      </Button>
                    </Box>
                  ...
                  <Flex m={2}>
                    ...
                    <Box>
                      <Button
                        borderRadius={"50%"}
                        onClick={() => setPets((prev) => Math.max(prev - 1, 0))}
                        disabled={pets <= 0}
                        opacity={pets <= 0 ? 0.1 : 1}
                      >
                        -
                      </Button>
                      <Input
                      ...
                      <Button
                        borderRadius={"50%"}
                        onClick={() => setPets((prev) => Math.min(prev + 1, 4))}
                        disabled={pets >= 4}
                        opacity={pets >= 4 ? 0.1 : 1}
                      >
                        +
                      </Button>
                    </Box>
              ...
              <Grid gap={2}>
                <Flex color={"grey.400"} fontSize={["sm", "sm", "md", "md"]}>
                  <Text textDecor={"underline"}>
                    ${propertyData.price} x {stayNights} night
                  </Text>
                  <Spacer />
