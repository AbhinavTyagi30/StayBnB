  ...
  return (
   ...
   <div id = "checkout-component">
          ...
          <div id="orderSummary">
            ...
            <Box display='grid' gridTemplateColumns='40% 1fr' w='auto'  borderRadius='lg' overflow='hidden'>
              <Image bg='red' borderRadius='50%' marginTop='20px' p='2px' h='180px' w='180px' src={data?.images[0]} alt={data?.name} />
              <Box  p='1px'>
