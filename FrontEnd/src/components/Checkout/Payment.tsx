        ...
        <div className="container">
            <div className={`card-container ${isFlipped ? 'flipped' : ''}`}>
                <div className="front">
                    ...
                    <div className="card-number-box" style={{ color: 'white' }}>{cardNumber}</div>
                    <div className="flexbox">
                        <div className="box">
                            <span style={{ color: 'white' }}>card holder :</span>
                            <div className="card-holder-name" style={{ color: 'white' }}>{cardHolder}</div>
                        </div>
                        <div className="box">
                            <span style={{ color: 'white' }}>expires :</span>
                            <div className="expiration">
                                <span className="exp-month" style={{ color: 'white' }}>{expMonth} \ {expYear}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flexbox">
                    ...
                    <div className="inputBox">
                        <span>cvv</span>
                        <input type="text" maxLength={4} className="cvv-input" onChange={handleCvvChange} onMouseEnter={handleCvvHover} onMouseLeave={handleCvvLeave} />
                    </div>
                </div>
