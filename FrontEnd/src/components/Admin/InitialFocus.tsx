 ...
 const InitialFocus:FC = () =>{
    const { isOpen, onOpen, onClose } = useDisclosure()
     const initState = {
        ...
        name : "",
        host_name:"",
        host_thumbnail_url: "https://a0.muscache.com/im/users/9028043/profile_pic/1413189878/original.jpg?aki_policy=profile_small",
        host_picture_url: "https://a0.muscache.com/im/users/9028043/profile_pic/1413189878/original.jpg?aki_policy=profile_x_medium",
        smart_location : "",
        accomodates: 4,
        bathrooms: 0,
        bedrooms: 0,
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // console.log(formState);
          (async ()=>{
        try{
            const response = await axios.post("https://staybnb-server.onrender.com/property",formState)
          ...
          <ModalContent>
            ...
            <ModalBody pb={6}>
              ...
              <FormControl mt={4} display={"grid"} gridTemplateColumns={"auto"}>
                ...
                <Input name="host_name" placeholder='Host name' 
  onChange={handleChange} />
                <FormLabel>Beds</FormLabel>
                <Input name="bedrooms" placeholder='Number of Beds' type="number" 
  onChange={handleChange}/>
                <FormLabel>Baths</FormLabel>
                <Input name="bathrooms" placeholder='Number of Baths' type="number" 
  onChange={handleChange} />
                <FormLabel>Location</FormLabel>
                <Input name="smart_location" placeholder='location' 
  onChange={handleChange}/>
  ...
  onChange={handleChange} />
              ...
              <Button onClick={onClose} mr={3} mt={3}>Cancel</Button>
              </form>
            </ModalBody>
          </ModalContent>
        </Modal>
