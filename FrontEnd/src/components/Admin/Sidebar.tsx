  ...
  return (
    <Box
      ...
      <Flex h="20" alignItems="center" mx="8" justifyContent="space-between">
        <Image src="/src/assets/logo/long-logo.png"/>
    ...
    <Flex
      ...
      />
       ...
       <Text
        ...
        fontWeight="300" color={"tomato"}>
        Hello Admin
      </Text>
        <Image display={{ base: 'flex', md: 'none' }} src="/src/assets/logo/long-logo.png"w={"10em"} h={"5em"}/>
        

      {/* <Image src="./Logo\logo.jpeg"/> */}
            ...
            <MenuButton py={2} transition="all 0.3s" _focus={{ boxShadow: 'none' }}>
              <HStack>
                ...
                <VStack
                  ...
                  spacing="1px"
                  ml="2">
                  <Text fontSize="sm">StayBnB Admin</Text>
